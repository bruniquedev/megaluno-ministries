...
@if(!isset($DataToEdit['id']) || $DataToEdit['id']==0)
    <form role="form" method="post" action="{{ route('manage-projects.store') }}" name="FORM" class="about-form" id="about-form" enctype="multipart/form-data">
    @else
    <form action="{{ route('manage-projects.update', $DataToEdit['id']) }}" method="post" name="FORM" 
      ...
      <div class="load-animate animated fadeInUp">
         <div class="row">
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
               <h2 class="h2-title">Save / Create a project</h2> 
            </div>               
         </div>
  ...
  <div class="row">
             ...
             <div class="col-md-2">
                <div class="form-groupy">
                  <label for="text">Project heading </label>
 ...
 <div class="col-md-3">
    <div class="form-groupy">
                  ...
                  <div class="form-input-group">
                  <textarea class="form-control input_box_borderless" rows="2" name="descriptiontext" id="descriptiontext" ><?php echo $DataToEdit['descriptiontext']; ?></textarea>
               </div>
               </div>
                </div>
             ...
             <div class="col-md-2">
               ...
               <div id="custom-img" style="background-image: url('{{ asset("storage/projects_images/thumbnails/".$DataToEdit["filename"]) }}'); width:40px;height:40px;"></div>
            </div>  
   ...
   <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
               <h2 class="h2-title">Project details</h2> 
            </div>               
         </div>
