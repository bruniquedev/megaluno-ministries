...
@if(!isset($DataToEdit['id']) || $DataToEdit['id']==0)
    <form role="form" method="post" action="{{ route('manage-individual-profile.store') }}" name="FORM" class="about-form" id="about-form" enctype="multipart/form-data">
    @else
    <form action="{{ route('manage-individual-profile.update', $DataToEdit['id']) }}" method="post" name="FORM" 
      ...
      <div>
         <div class="row">
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
               ...
               <h4 class="h2-title m-r-10">Save / Create Individual profile</h4> 
  ...
  <div class="row">
   ...
   <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
               <h4 class="h2-title">Individual profile details</h4> 
            </div>               
         </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
               <table class="dynam-table table-container ministry-view-table" addRowBtnTarget="addRowBtnList" RemoveRowsBtnTarget="deleteCheckedRowsBtnList"> 
                ...
                <tr class="thead table-light">
                     ...
                     <th scope="col" width="35%">Heading</th>
