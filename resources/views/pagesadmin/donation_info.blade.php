...
<td>  <div id="custom-img" style="background-image: url('{{ asset("storage/donations_images/thumbnails/".$Info->filename) }}'); width:40px;height:40px;"></div></td>
...
?>
<td><a class="<?php echo $buttonstatus; ?>" id="link1" href="/manage-donations/{{$Info->id}}"><i class="ion ion-edit"></i> <?php echo $statusText; ?></a></td>

<td><a href="/manage-donations/{{$Info->id}}/edit" class="btn btn-primary btn-xs"  title="Edit about info"><span class="ion ion-edit"></span> edit</a></td>
<td>
