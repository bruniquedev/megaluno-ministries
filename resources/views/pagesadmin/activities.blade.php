...
<h4 class="m-r-10">Activity info</h4>
...
<td><a href="/manage-activities/{{$Info->id}}/edit" class="btn-ui btn-ui-primary btn-xs"  title="Edit info"><span class="ion ion-edit"></span> edit</a></td>
<td>
<form action="{{ route('manage-activities.destroy', $Info->id) }}" method="post" name="FORM" 
