      ...
      <div class="load-animate animated fadeInUp">
         <div class="row">
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
               <h2 class="h2-title">Save / Create an event</h2> 
            </div>               
         </div>
  ...
  <div class="row">
             ...
             <div class="col-md-2">
                <div class="form-groupy">
                  <label for="text">Event heading </label>
 ...
 <div class="col-md-3">
    <div class="form-groupy">
             ...
             <div class="col-md-2">
               ...
               <div id="custom-img" style="background-image: url('{{ asset("storage/events_images/thumbnails/".$DataToEdit["filename"]) }}'); width:40px;height:40px;"></div>
            </div>  
   ...
   <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
               <h2 class="h2-title">Event details</h2> 
            </div>               
         </div>
