...
@if(!isset($DataToEdit['id']) || $DataToEdit['id']==0)
    <form role="form" method="post" action="{{ route('manage-events.store') }}" name="FORM" class="about-form" id="about-form" enctype="multipart/form-data">
    @else
    <form action="{{ route('manage-events.update', $DataToEdit['id']) }}" method="post" name="FORM" 
      ...
      <div>
         <div class="row">
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
               ...
               <h4 class="h2-title m-r-10">Save / Create Event info</h4> 
               <a class="btn-ui btn-ui-primary btn-ui-xs" id="link1" href="{{ route('manage-events.create') }}"><i class="ion ion-android-add-circle"></i> Create</a>
           </div>
            </div>               
         </div>
  ...
  <div class="row">
           ...
           <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
             <div class="form-groupy">
           <label for="text">Select event status</label> 
           <div class="form-input-group">   
         <select required="required"  class="input-control" name="ispublished">
         <option value=""></option>
         <option value="0" <?php if($DataToEdit['ispublished']==0){ echo " selected "; } ?>>Upcoming Event</option>
         <option value="1" <?php if($DataToEdit['ispublished']==1){ echo " selected "; } ?>>Expired event</option>
         </select>
         </div>
            </div>
         </div>
   ...
   <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
               <h4 class="h2-title">Event details</h4> 
            </div>               
         </div>
