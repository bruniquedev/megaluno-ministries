...
@if(!isset($DataToEdit['id']) || $DataToEdit['id']==0)
    <form role="form" method="post" action="{{ route('manage-services.store') }}" name="FORM" class="about-form" id="about-form" enctype="multipart/form-data">
    @else
      ...
      <div>
         <div class="row">
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
               ...
               <h4 class="h2-title m-r-10">Save / Create a service info</h4> 
  ...
  <div class="row">
   ...
   <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
               <h4 class="h2-title">Service details</h4> 
            </div>               
         </div>
