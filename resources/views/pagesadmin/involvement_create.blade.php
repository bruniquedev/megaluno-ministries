...
@if(!isset($DataToEdit['id']) || $DataToEdit['id']==0)
    <form role="form" method="post" action="{{ route('manage-involvements.store') }}" name="FORM" class="about-form" id="about-form" enctype="multipart/form-data">
    @else
    <form action="{{ route('manage-involvements.update', $DataToEdit['id']) }}" method="post" name="FORM" 
      ...
      <div>
         <div class="row">
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
               ...
               <h4 class="h2-title m-r-10">Save / Create involvement info</h4> 
               <a class="btn-ui btn-ui-primary btn-ui-xs" id="link1" href="{{ route('manage-involvements.create') }}"><i class="ion ion-android-add-circle"></i> Create</a>
            </div>
            </div>               
         </div>
  ...
  <div class="row">
   ...
   <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
               <h4 class="h2-title">Involvement details</h4> 
            </div>               
         </div>
