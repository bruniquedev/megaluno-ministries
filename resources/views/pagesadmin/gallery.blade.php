...
<h4 class="m-r-10">Save Gallery Image</h4>
<a class="btn-ui btn-ui-primary btn-ui-xs" id="link1" href="{{ route('manage-gallery.index') }}"><i class="ion ion-android-add-circle"></i> Create</a>
</div>
