...
<td>  <div id="custom-img" style="background-image: url('{{ asset("storage/events_images/thumbnails/".$Info->filename) }}'); width:40px;height:40px;"></div></td>
...
?>
<td><a class="<?php echo $buttonstatus; ?>" id="link1" href="/manage-events/{{$Info->id}}"><i class="ion ion-edit"></i> <?php echo $statusText; ?></a></td>

<td><a href="/manage-events/{{$Info->id}}/edit" class="btn btn-primary btn-xs"  title="Edit about info"><span class="ion ion-edit"></span> edit</a></td>
<td>
<form action="{{ route('manage-events.destroy', $Info->id) }}" method="post" name="FORM" 
