...
<h4 class="m-r-10">Events Info</h4>
...
<td>
  <?php if($Info->ispublished==0){ echo " Upcoming Event "; } ?>
  <?php if($Info->ispublished==1){ echo " Expired event "; } ?>
</td>
...
<td><a href="/manage-events/{{$Info->id}}/edit" class="btn-ui btn-ui-primary btn-xs"  title="Edit info"><span class="ion ion-edit"></span> edit</a></td>
<td>
