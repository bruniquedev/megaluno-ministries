...
<h4 class="m-r-10">Sermons info</h4>
...
<td><?php echo $Info->day_date; ?></td>

<td><a href="/manage-sermons/{{$Info->id}}/edit" class="btn-ui btn-ui-primary btn-xs"  title="Edit info"><span class="ion ion-edit"></span> edit</a></td>
<td>
<form action="{{ route('manage-sermons.destroy', $Info->id) }}" method="post" name="FORM" 
