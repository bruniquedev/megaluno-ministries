...
@if(!isset($DataToEdit['id']) || $DataToEdit['id']==0)
    <form role="form" method="post" action="{{ route('manage-sermons.store') }}" name="FORM" class="about-form" id="about-form" enctype="multipart/form-data">
    @else
    <form action="{{ route('manage-sermons.update', $DataToEdit['id']) }}" method="post" name="FORM" 
      ...
      <div>
         <div class="row">
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
               ...
               <h4 class="h2-title m-r-10">Save / Create a sermon info</h4> 
               <a class="btn-ui btn-ui-primary btn-ui-xs" id="link1" href="{{ route('manage-sermons.create') }}"><i class="ion ion-android-add-circle"></i> Create</a>
            </div>
            </div>               
         </div>
  ...
  <div class="row">
            ...
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                <div class="form-groupy">
                  ...
                  <div class="form-input-group">
                  <textarea class="form-control input_box_borderless" rows="2" name="heading"><?php echo $DataToEdit['heading']; ?></textarea>
               </div>
               </div>
            </div>    
             ...
             <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                    <div class="form-groupy">
                  <label for="text">Description of heading </label>
                  <div class="form-input-group">
            ...
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
               <div class="form-groupy">
               <div class="input_label">Featured image</div>
               <!--upload field one-->
             ...
             <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                <div class="form-groupy">
                  <label for="text">Sermon by </label>
                  <div class="form-input-group">
                  <textarea class="form-control input_box_borderless" rows="2" name="publisher"><?php echo $DataToEdit['publisher']; ?></textarea>
               </div>
               </div>
            </div>
            ...
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                <div class="form-groupy">
                  <label for="text">Sermon date </label>
                  <div class="form-input-group">
                  <textarea class="form-control input_box_borderless" rows="2" name="day_date"><?php echo $DataToEdit['day_date']; ?></textarea>
               </div>
               </div>
            </div>    
   ...
   <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
               <h4 class="h2-title">Sermon details</h4> 
            </div>               
         </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
               <table class="dynam-table table-container ministry-view-table" addRowBtnTarget="addRowBtnList" RemoveRowsBtnTarget="deleteCheckedRowsBtnList"> 
                ...
                <tr class="thead table-light">
                     ...
                     <th scope="col" width="15%">Video URL</th>
                     <th scope="col" width="8%">Remove</th>
                  </tr> 
                   </thead>
        <tbody data-inputs='[
    {"type": "textarea", "attributes": {"name": "detailtitlelist[]", "rows": "3", "label": "Title", "class": "input-control"}},
    ...
    {"type": "textarea", "attributes": {"name": "videofilelist[]", "rows": "3", "label": "Video URL", "class": "input-control","placeholder": "Sources like youtube etc"}}
            ...
            <!-- Table rows will be dynamically added here -->  
                  ...
                  <tr>
                    ...
                    <label for="text">Title</label>
                    <div class="form-input-group">
                    <textarea class="input-control" rows="3" name="detailtitlelist[]"></textarea>
                    </div>
                    </div>
                    </td>
    ...
    <textarea class="input-control" rows="3" name="detaildescriptionlist[]"></textarea></div></div>
            ...
            <div class="custom-img-previewer" style="width:40px;height:40px;">
             ...
             <td data-label="Video URL">
               ...
               <div class="form-input-group">
   <textarea class="input-control" rows="3" name="videofilelist[]" placeholder="Sources like youtube etc"></textarea></div></div>
                  </td> 
...
<label for="text">Title</label>
<div class="form-input-group">
<textarea class="input-control" rows="3" name="detailtitlelist[]"><?php echo $ListdetailItem->titlelist; ?></textarea>
</div>
</div>
</td>
...
<div class="custom-img-previewer" style="background-image: url('{{ asset("storage/content_uploads/details/thumbnails/".$ListdetailItem->filenamelist) }}'); width:40px;height:40px;">
   ...
   <label for="text">Video URL</label>
   <div class="form-input-group">
   <textarea class="input-control" rows="3" name="videofilelist[]" placeholder="Sources like youtube etc"><?php echo $ListdetailItem->video_filelist; ?></textarea></div></div>
   </td>
