...
<h4 class="m-r-10">Involvements info</h4>
...
<td><a href="/manage-involvements/{{$Info->id}}/edit" class="btn-ui btn-ui-primary btn-xs"  title="Edit info"><span class="ion ion-edit"></span> edit</a></td>
<td>
<form action="{{ route('manage-involvements.destroy', $Info->id) }}" method="post" name="FORM" 
