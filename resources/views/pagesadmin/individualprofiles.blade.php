...
<td><a href="/manage-individual-profile/{{$Info->id}}/edit" class="btn-ui btn-ui-primary btn-xs"  title="Edit info"><span class="ion ion-edit"></span> edit</a></td>
<td>
<form action="{{ route('manage-individual-profile.destroy', $Info->id) }}" method="post" name="FORM" 
