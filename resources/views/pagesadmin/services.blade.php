...
<a class="btn-ui btn-ui-primary btn-ui-xs" id="link1" href="{{ route('manage-services.create') }}"><i class="ion ion-android-add-circle"></i> Create</a>
</div>
@if (session('success'))
...
<td><a href="/manage-services/{{$Info->id}}/edit" class="btn-ui btn-ui-primary btn-xs"  title="Edit info"><span class="ion ion-edit"></span> edit</a></td>
<td>
<form action="{{ route('manage-services.destroy', $Info->id) }}" method="post" name="FORM" 
