...
<select required="required"  class="input-control" data-live-search="true" name="socialtype">
@if($DataToEdit['socialtype']!="")
  <option value="{{$DataToEdit['socialtype']}}" selected>{{$DataToEdit['socialtype']}}</option>
  @endif
<option value=""></option>
<option value="ion-social-facebook">Facebook</option>
<option value="ion-social-instagram">Instagram</option>
<option value="ion-social-twitter-outline">Twitter</option>
<option value="ion-social-linkedin-outline">Linkedin</option>
<option value="ion-social-whatsapp-outline">WhatsApp</option>
<option value="ion-android-mail">Mail</option>
<option value="ion-social-youtube-outline">YouTube</option>
<option value="ion-social-pinterest">Pinterest</option>
</select>
</div>
   </div>
      ...
      <div class="form-groupy">
<label for="name" id="MessageLabel"> Paste social link here</label>
 <div class="form-input-group">
<textarea required="required"  
 class="input-control" name="descriptiontext" id="descriptiontext"  rows="8">
...
id="id" class="input-control" name="id">
</div>
</div> 
