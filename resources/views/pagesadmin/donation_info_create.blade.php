...
@if(!isset($DataToEdit['id']) || $DataToEdit['id']==0)
      ...
      <div class="load-animate animated fadeInUp">
         <div class="row">
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
               <h2 class="h2-title">Save / Create donation info</h2> 
            </div>               
         </div>
  ...
  <div class="row">
             ...
             <div class="col-md-2">
                <div class="form-groupy">
                  <label for="text">Donation info heading </label>
 ...
 <div class="col-md-3">
    <div class="form-groupy">
                  <label for="text">Donation description </label>
                  <div class="form-input-group">
             ...
             <div class="col-md-2">
               ...
               <div id="custom-img" style="background-image: url('{{ asset("storage/donations_images/thumbnails/".$DataToEdit["filename"]) }}'); width:40px;height:40px;"></div>
            </div>  
