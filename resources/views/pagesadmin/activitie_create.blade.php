...
@if(!isset($DataToEdit['id']) || $DataToEdit['id']==0)
      ...
      <div class="load-animate animated fadeInUp">
         <div class="row">
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
               <h2 class="h2-title">Save / Create a programme info</h2> 
            </div>               
         </div>
  ...
  <div class="row">
             ...
             <div class="col-md-2">
                <div class="form-groupy">
                  <label for="text">Programme heading </label>
 ...
 <div class="col-md-3">
    <div class="form-groupy">
                  <label for="text">Programme description </label>
                  <div class="form-input-group">
             ...
             <div class="col-md-2">
               ...
               <div id="custom-img" style="background-image: url('{{ asset("storage/activities_images/thumbnails/".$DataToEdit["filename"]) }}'); width:40px;height:40px;"></div>
            </div>  
   ...
   <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
               <h2 class="h2-title">Programme details</h2> 
            </div>               
         </div>
