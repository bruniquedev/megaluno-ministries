...
<?php if($option=="details"){ ?>
    <!--about section-->
    <div class="section_area">
<div class="aboutarea sneekpeek-details-area background-img bg-img-attachment" style="background-image: url('{{asset("storage/activities_images/thumbnails/".$Details[0]["filename"]) }}');"><!---->
