...
return view('pagesadmin.individualprofiles_create', [
        'DataToEdit' => $Data,
...
'page_area_type' => 'individualprofile',
...
$detailItems =DB::select('select * from content_details where related_id=:related_id order by ordersort asc',["related_id"=>$id]);
   ...
   return view('pagesadmin.individualprofiles_create')->with('ListdetailItems',$detailItems)->with('DataToEdit', $Data);
    }
