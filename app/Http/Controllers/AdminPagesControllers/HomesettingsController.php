...
$data = content_info::where('page_area_type', 'home')->get();
 ...
 return view('pagesadmin.home_intro_create')->with('ListdetailItems',$contentdetailItems)->with('DataToEdit', $Data);
    }
...
$detailItems =DB::select('select * from content_details where related_id=:related_id order by ordersort asc',["related_id"=>$id]);
   ...
   return view('pagesadmin.home_intro_create')->with('ListdetailItems',$detailItems)->with('DataToEdit', $Data);
    }
