...
$data = content_info::where('page_area_type', 'donation')->orderBy('sorted_order', 'asc')->get();
...
return view('pagesadmin.donation_info_create', [
        'DataToEdit' => $Data,
...
return back()->with('success', 'Content saved!');
   ...
   public function destroy($id)
    ...
    {
           $content = donations::findOrFail($id);
           $content->delete();
